...
const EmployeeEdit = () => {
    ...
    //                                 control={control}
    //                                 render={({ field: { onChange, value } }) => (
    //                                     <TextField required fullWidth onChange={onChange} defaultValue={employee.firstName} value={value} label={"First Name"} />
    //                                 )}
    //                             />
    //                         </Grid>
    //                         <Grid item xs={12} sm={6}>
    ...
    //                                 control={control}
    //                                 render={({ field: { onChange, value } }) => (
    //                                     <TextField required fullWidth onChange={onChange} defaultValue={employee.lastName} value={value} label={"Last Name"} />
    //                                 )}
    //                             />
    //                         </Grid>
    //                         <Grid item xs={12} sm={6}>
    ...
    //                                 control={control}
    //                                 render={({ field: { onChange, value } }) => (
    //                                     <TextField fullWidth onChange={onChange} defaultValue={employee.completeName} value={value} label={"Complete Name"} />
    //                                 )}
    //                             />
    //                         </Grid>
    //                         <Grid item xs={12} sm={6}>
    ...
    //                                 control={control}
    //                                 render={({ field: { onChange, value } }) => (
    //                                     <TextField fullWidth onChange={onChange} defaultValue={employee.address} value={value} label={"Address"} />
    //                                 )}
    //                             />
    //                         </Grid>
    //                         <Grid item xs={12} sm={6}>
    ...
    //                                 control={control}
    //                                 render={({ field: { onChange, value } }) => (
    //                                     <FormControlLabel fullwidth control={<Checkbox onChange={onChange} checked={employee.isRemote ? true : false}/>} label="Remote" />
    //                                 )}
    //                             />
    //                         </Grid>
    //                         <Grid item xs={12} sm={6}>
    ...
    //                                         <Select
    //                                             value={value}
    //                                             defaultValue={employee.nativeLanguage}
    //                                             label="Native Language"
    //                                             onChange={onChange}
    //                                         >
    //                                             <MenuItem value={1}>English</MenuItem>
    ...
    //                                         <Select
    //                                             value={value}
    //                                             defaultValue={employee.teamPosition}
    //                                             label="Team Position"
    //                                             onChange={onChange}
    //                                         >
    //                                             <MenuItem value={"Team Leader"}>Team Leader</MenuItem>
    ...
    //                                 control={control}
    //                                 render={({ field: { onChange, value } }) => (
    //                                     <TextField select fullWidth onChange={onChange} defaultValue={employee.teamId} value={value} label={"Team"} >
    //                                         {
    //                                             teams.map((team, index) => (
    //                                                 <MenuItem key={index} value={team}>
    //                                                     {`Team ${team}`}
    ...
    //                                 control={control}
    //                                 render={({ field: { onChange, value } }) => (
    //                                     <TextField fullWidth onChange={onChange} defaultValue={employee.phoneNumber} value={value} label={"Phone Number"} />
    //                                 )}
    //                             />
    //                         </Grid>
    //                         <Grid item xs={12} sm={6}>
    ...
    //                                 control={control}
    //                                 render={({ field: { onChange, value } }) => (
    //                                     <TextField fullWidth onChange={onChange} defaultValue={employee.email} value={value} label={"Email"} />
    //                                 )}
    //                             />
    //                         </Grid>
    //                     </Grid>
