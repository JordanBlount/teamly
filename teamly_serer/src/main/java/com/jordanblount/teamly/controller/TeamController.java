...
public class TeamController {
    ...
    public ResponseEntity<Team> getTeamById(@PathVariable Long id) {
        Team team = teamRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("This team was not found."));
    ...
    public List<Team> getTeamByName(@PathVariable String name) {
        ...
        if(teams.isEmpty()) {
            System.out.println(new ResourceNotFoundException("Teams(s) with the name "+ name +" not found"));
        }
        return teams;
    }
    ...
    public List<Team> getTeamByType(@PathVariable Integer type) {
        ...
        if(teams.isEmpty()) {
            System.out.println(new ResourceNotFoundException("Teams(s) with the type "+ type +" not found"));
        }
        return teams;
    }
    ...
    public List<Team> getTeamByOrgId(@PathVariable Integer orgId) {
        ...
        if(teams.isEmpty()) {
            System.out.println(new ResourceNotFoundException("Teams(s) with the orgId "+ orgId +" not found"));
        }
        return teams;
    }
